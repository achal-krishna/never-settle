...
export default function Signup() {
  ...
  async function signup(){
    ...
    let user;
    try{
      let result= await fetch('https://never-settle.herokuapp.com/user/register',{
      method:'POST',
      headers:{
  ...
  return (
    <>
            ...
            <div style={{textAlign:'center',backgroundColor:'#00A4EF',borderRadius:'0.5vw',cursor:'pointer'}} onClick={signup} >
