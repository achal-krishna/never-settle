...
export default function Login() {
  ...
  async function login(){
    ...
    let user;
    try{
      let result= await fetch('https://never-settle.herokuapp.com/user/login',{
      method:'POST',
      headers:{
      ...
      if(result.error == null)
      {
        ...
        let groups= await fetch(`https://never-settle.herokuapp.com/user/groups/${user.id}`,{
          method:'GET',
          headers:{
              "Content-Type":"application/json",
  ...
  return (
    <>
            ...
            <p className='login-head'>Never<span style={{color:'#00A4EF'}}>Settle</span></p>
            ...
            <div style={{textAlign:'center',backgroundColor:'#00A4EF',borderRadius:'0.5vw',cursor:'pointer'}} onClick={login} >
