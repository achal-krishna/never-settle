...
export default function Organizations({name,id,fun}) {
  ...
  useEffect( () => {
    async function fetchData() {
     let expenses= await fetch(`https://never-settle.herokuapp.com/groups/expenses/${id}`,{
      method:'GET',
      headers:{
      ...
      if(users==null){ 
     let paidby= await fetch(`https://never-settle.herokuapp.com/groups/users/${id}`,{
      method:'GET',
      headers:{
          "Content-Type":"application/json",
          "Accept":"application/json",
...
async function gameOn() {
      ...
      try{
      let paidby=  await fetch(`https://never-settle.herokuapp.com/FinalSplit/${id}`,{
      method:'GET',
      headers:{
          "Content-Type":"application/json",
          "Accept":"application/json",
  ...
  async function createExpense(){
    ...
    try{
      let result= await fetch('https://never-settle.herokuapp.com/expense/create',{
      method:'POST',
      headers:{
          "Content-Type":"application/json",
      },
