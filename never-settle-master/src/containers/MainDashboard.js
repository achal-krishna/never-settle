...
export default function MainDashboard() {
  ...
  useEffect( () => {
    async function fetchData() {
     let paidby= await fetch(`https://never-settle.herokuapp.com/user/all`,{
      method:'GET',
      headers:{
  ...
  async function creategroup(){
    ...
    try{
      let result= await fetch('https://never-settle.herokuapp.com/groups/create',{
      method:'POST',
      headers:{
          "Content-Type":"application/json",
      },
    ...
    let totalgroups= await fetch(`https://never-settle.herokuapp.com/user/groups/${currUser.id}`,{
      method:'GET',
      headers:{
          "Content-Type":"application/json",
          "Accept":"application/json",
